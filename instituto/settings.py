...
SECRET_KEY = 'django-insecure-$d$kp4_25fx^*lp3*6i9ixk#_q)92mtybdo4k4zzi(f)8(vr^='
...
DATABASES = {
    'default': {
        ...
        'USER': 'user',            # Usuario definido en MySQL
        'PASSWORD': 'password',    # Contraseña del usuario
        'HOST': 'db',              # Nombre del servicio en Docker Compose
        'PORT': '3306',            # Puerto interno de MySQL en el contenedor
        'OPTIONS': {
